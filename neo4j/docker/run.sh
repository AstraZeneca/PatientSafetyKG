...
docker run \
    ...
    -d \
    -v $HOME/SageMaker/neo4j/data:/data \
    -v $HOME/SageMaker/neo4j/logs:/logs \
    -v $HOME/SageMaker/neo4j/import:/var/lib/neo4j/import \
    -v $HOME/SageMaker/neo4j/plugins:/plugins \
